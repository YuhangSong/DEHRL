...
The paper is published on [Proceedings of the 33rd National Conference on Artificial Intelligence (AAAI 2019)](https://www.computer.org/web/tpami), as an **Oral Presentation**.
The work is conducted by [Intelligent Systems Lab](http://www.cs.ox.ac.uk/people/thomas.lukasiewicz/isg-index.html) @ [Computer Science](http://www.cs.ox.ac.uk/) in [University of Oxford](http://www.ox.ac.uk/).
...
:-------------------------:|:-------------------------:
<img src="imgs/AntBulletEnv-v0/rendered.gif">  |  <img src="imgs/AntBulletEnv-v0/resulted_states.gif">
