...
class MineCraft(pyglet.window.Window,gym.Env):
    ...
    def get_obs(self):
        ...
        return np.array(Image.frombytes(mode=self.obs_type_to_pil_mode[self.obs_type], size=(self.obs_size, self.obs_size), data=self.buffer).transpose(Image.FLIP_TOP_BOTTOM))
