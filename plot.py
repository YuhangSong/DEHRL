...
import simple_rl
simple_rl.utils.chart_utils.make_plots(experiment_dir='./results/gridworld_h-3_w-4', experiment_agents=['dd'], plot_file_name="", cumulative=True, use_cost=False, episodic=True, open_plot=True, track_disc_reward=False)
